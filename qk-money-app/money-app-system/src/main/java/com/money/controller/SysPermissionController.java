...
public class SysPermissionController {
    ...
    @Operation(summary = "返回所有子节点ID，包含自身ID", tags = "permission")
    ...
    @Operation(summary = "分页查询权限信息", tags = "permission")
    @GetMapping
    @PreAuthorize("@rbac.hasPermission('permission:list')")
    ...
    @Operation(summary = "添加权限信息", tags = "permission")
    @PostMapping
    ...
    @Operation(summary = "修改权限信息", tags = "permission")
    @PutMapping
    ...
    @Operation(summary = "删除权限信息", tags = "permission")
    @DeleteMapping
