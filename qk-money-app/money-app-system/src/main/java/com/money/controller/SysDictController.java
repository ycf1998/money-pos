...
public class SysDictController {
    ...
    @Operation(summary = "添加字典", tags = {"dict"})
    @PostMapping
    ...
    @Operation(summary = "修改字典", tags = {"dict"})
    @PutMapping
    ...
    @Operation(summary = "修改字典详情", tags = {"dict"})
    @PutMapping("/detail")
    @PreAuthorize("@rbac.hasPermission('dict:edit')")
    ...
    @Operation(summary = "删除字典详情", tags = {"dict"})
